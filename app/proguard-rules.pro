#---------------------------------定制化区域---------------------------
#--------------------------1.实体类-----------------------------------
-keep class com.nhgaohe.certificateandroid_libv2.pojo.**{*;}
...
#--------------------------4.反射相关的类和方法---------------------------
-keepclasseswithmembers class com.nhgaohe.certificateandroid_libv2.utils.GDCAMResource {
    <methods>;
}

#--------------------------5.其他类-----------------------------------
-keep class com.nhgaohe.certificateandroid_libv2.utils.GDCAHttpsClientUtil {
    <fields>;
    <methods>;
}

-keepclasseswithmembers class com.nhgaohe.certificateandroid_libv2.utils.GDCAJsonUtils {
    <methods>;
}

-keep class com.nhgaohe.certificateandroid_libv2.utils.GDCAStringUtils{
   <fields>;
   <methods>;
}

-keep class com.nhgaohe.certificateandroid_libv2.asynctask.*{
   <fields>;
   <methods>;
}
