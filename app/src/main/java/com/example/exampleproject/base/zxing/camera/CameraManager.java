...
package com.example.exampleproject.base.zxing.camera;
...
import com.example.exampleproject.base.zxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
  ...
  private static int findDesiredDimensionInRange(int resolution, int hardMin, int hardMiddle,int hardMax) {
