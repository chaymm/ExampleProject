...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewHolder> {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_LOAD_MORE:
                ...
                View footerView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_load_more_footer, parent, false);
                viewHolder = new BaseRecyclerViewHolder(footerView);
                break;
            case VIEW_TYPE_LOAD_DONE:
                View tipView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_load_done, parent, false);
                TextView tipTv = (TextView) tipView.findViewById(R.id.done_tip_tv);
                tipTv.setText(loadDoneTip);
                viewHolder = new BaseRecyclerViewHolder(tipView);
                break;
            case VIEW_TYPE_HEADER:
                viewHolder = new BaseRecyclerViewHolder(mHeaderView);
                break;
            case VIEW_TYPE_FOOTER:
                viewHolder = new BaseRecyclerViewHolder(mFooterView);
                break;
            case VIEW_TYPE_EMPTY_VIEW:
                ...
                viewHolder = new BaseRecyclerViewHolder(mEmptyView);
                break;
            default:
    ...
    public BaseRecyclerViewHolder createDefaultViewHolder(int layoutResId, ViewGroup parent, int viewType) {
        return new BaseRecyclerViewHolder(mContext, getItemView(layoutResId, parent));
    }
