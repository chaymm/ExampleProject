package com.example.exampleproject.base.view.pullrecyclerview;
...
import com.example.exampleproject.base.view.pullrecyclerview.layoutmanager.XLinearLayoutManager;
...
public class PullRecyclerView extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.recyclerview_pull_layout, this, true);
