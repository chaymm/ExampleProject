package com.example.exampleproject.data.util.net.okhttp;
...
import com.example.exampleproject.data.util.net.okhttp.cache.CacheEntity;
import com.example.exampleproject.data.util.net.okhttp.cache.CacheMode;
import com.example.exampleproject.data.util.net.okhttp.cookie.CookieJarImpl;
import com.example.exampleproject.data.util.net.okhttp.cookie.store.CookieStore;
import com.example.exampleproject.data.util.net.okhttp.https.HttpsUtils;
import com.example.exampleproject.data.util.net.okhttp.interceptor.HttpLoggingInterceptor;
import com.example.exampleproject.data.util.net.okhttp.model.HttpHeaders;
import com.example.exampleproject.data.util.net.okhttp.model.HttpParams;
import com.example.exampleproject.data.util.net.okhttp.request.DeleteRequest;
import com.example.exampleproject.data.util.net.okhttp.request.GetRequest;
import com.example.exampleproject.data.util.net.okhttp.request.HeadRequest;
import com.example.exampleproject.data.util.net.okhttp.request.OptionsRequest;
import com.example.exampleproject.data.util.net.okhttp.request.PostRequest;
import com.example.exampleproject.data.util.net.okhttp.request.PutRequest;
import com.example.exampleproject.data.util.net.okhttp.utils.OkLogger;
...
public class OkHttpUtil {
    ...
    public static Context getContext() {
        if (context == null) throw new IllegalStateException("请先在全局Application中调用 OkHttpUtil.init() 初始化！");
        return context;
    }
     ...
     */
    public OkHttpUtil debug(String tag, Level level, boolean isPrintException) {
     ...
     */
    public OkHttpUtil setCertificates(X509TrustManager trustManager) {
     ...
     */
    public OkHttpUtil setCertificates(InputStream bksFile, String password, InputStream... certificates) {
     ...
     */
    public OkHttpUtil setCertificates(InputStream bksFile, String password, X509TrustManager trustManager) {
    ...
    /** 全局cookie存取规则 */
    public OkHttpUtil setCookieStore(CookieStore cookieStore) {
