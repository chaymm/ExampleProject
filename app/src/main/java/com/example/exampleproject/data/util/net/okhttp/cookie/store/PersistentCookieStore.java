package com.example.exampleproject.data.util.net.okhttp.cookie.store;
...
public class PersistentCookieStore implements CookieStore {
    ...
    public PersistentCookieStore() {
        cookiePrefs = OkHttpUtil.getContext().getSharedPreferences(COOKIE_PREFS, Context.MODE_PRIVATE);
        cookies = new HashMap<>();
