package com.example.exampleproject.data.util.net.okhttp.okserver.download;

import android.os.Message;
import android.text.TextUtils;

import com.example.exampleproject.data.util.net.okhttp.OkHttpUtil;
import com.example.exampleproject.data.util.net.okhttp.okserver.download.db.DownloadDBManager;
import com.example.exampleproject.data.util.net.okhttp.okserver.listener.DownloadListener;
import com.example.exampleproject.data.util.net.okhttp.okserver.task.PriorityAsyncTask;
...
public class DownloadTask extends PriorityAsyncTask<Void, DownloadInfo, DownloadInfo> {
    ...
    private final class ProgressRandomAccessFile extends RandomAccessFile {
        ...
        public void write(byte[] buffer, int offset, int count) throws IOException {
            ...
            //每200毫秒刷新一次数据
            if (curTime - lastRefreshUiTime >= OkHttpUtil.REFRESH_TIME || progress == 1.0f) {
                postMessage(null, null);
