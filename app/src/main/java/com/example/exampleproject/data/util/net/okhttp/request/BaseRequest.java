package com.example.exampleproject.data.util.net.okhttp.request;

import android.text.TextUtils;

import com.example.exampleproject.data.util.net.okhttp.OkHttpUtil;
import com.example.exampleproject.data.util.net.okhttp.adapter.CacheCall;
import com.example.exampleproject.data.util.net.okhttp.adapter.Call;
import com.example.exampleproject.data.util.net.okhttp.adapter.CallAdapter;
import com.example.exampleproject.data.util.net.okhttp.adapter.DefaultCallAdapter;
...
import com.example.exampleproject.data.util.net.okhttp.callback.AbsCallback;
import com.example.exampleproject.data.util.net.okhttp.convert.Converter;
...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    public okhttp3.Call generateCall(Request request) {
        ...
        if (readTimeOut <= 0 && writeTimeOut <= 0 && connectTimeout <= 0 && interceptors.size() == 0) {
            return OkHttpUtil.getInstance().getOkHttpClient().newCall(request);
        } else {
            OkHttpClient.Builder newClientBuilder = OkHttpUtil.getInstance().getOkHttpClient().newBuilder();
